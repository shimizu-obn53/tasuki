    ...
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-10 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p className="mb-3">
            2　前項の禁止は、本サービスを通じて最初に連絡・紹介がなされた日から<strong>1年間</strong>有効とします。
          </p>
          <p className="mb-3">
            3　1年以内に場外取引が発覚した場合、違反したユーザーは運営者に対し、<strong>金60,000円（税込）</strong>を損害賠償として支払う義務を負います（民法第420条に基づく損害賠償額の予定）。
          </p>
          <p className="mb-3">4　前項に加え、運営者は当該ユーザーに対し、以下の措置を取ることができます。</p>
          <ol className="space-y-2 pl-5 mb-3">
            <li>①　本サービスの利用停止またはアカウントの強制退会</li>
            <li>②　その他、運営者が適切と判断する措置</li>
          </ol>
          <p>5　場外取引による成約の場合も、第4条に定める手数料の支払義務は免れないものとします。</p>
        </section>
